...
Your donation goes towards supporting our programs and technology to build disability-friendly communities.`,
   ...
   'evaluations': {
      ...
      description: "Accessible Community provides flat fee evaluations for small-to-medium websites and social media.",
      bgImage: {
   ...
   'mentoring': {
      ...
      description: "A program that pairs senior experts with years of experience with novice digital accessibility professionals to mentor and guide them in their career development.",
      bgImage: {
   ...
   'tips': {
    ...
    'volunteer': {
      ...
      description: 'Accessible Community is a volunteer-led and staffed 501(c)3 organization. We welcome any contributions to help make our communities more accessible and disability-inclusive.',
      font: {
        title: {
          size: 56,
        },
