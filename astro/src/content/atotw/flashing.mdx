...
<ExternalLink inline href="https://www.ta11y.org/learning/topic?key=change.flash">Learn more about flashing</ExternalLink> at <span class="text-brand text-primary fw-bold">t<span class="fw-lighter">a11y</span>.org</span>.