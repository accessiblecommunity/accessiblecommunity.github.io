...
<ExternalLink inline href="https://www.ta11y.org/learning/topic?key=contrast.a_intro">Learn more about color contrast</ExternalLink> at <span class="text-brand text-primary fw-bold">t<span class="fw-lighter">a11y</span>.org</span>.