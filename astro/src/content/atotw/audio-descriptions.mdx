...
- **Descriptive transcripts** are static supplements to media. They are read separately from the media but are important for deaf-blind support.
...
Once the recording is complete, create a descriptive transcript by saving the caption file. You can then provide it as web content or text file. In YouTube, you can add it to the video description as you upload a video. For web pages, you can provide a link to the text adjacent to the video file. 
