...
We have provided a <ExternalLink inline={true} href="https://www.ta11y.org/learning/topic?key=plan.z_holidays">listing of the 2024 disability awareness days, weeks and months</ExternalLink> at <span class="text-brand text-primary fw-bold">t<span class="fw-lighter">a11y</span>.org</span>. Each period celebrates or raises awareness for a specific disability or disability-related topic. As you read through the list, if you see something you don't know about, follow the link to learn more. Education starts with each of us.
