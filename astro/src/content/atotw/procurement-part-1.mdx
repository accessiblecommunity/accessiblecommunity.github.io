...
When you buy a website, software, platform or other digital service, it is important to include accessibility as a requirement for that purchase. The first step is to ask if a <ExternalLink inline={true} href="https://www.itic.org/policy/accessibility/vpat">Voluntary Product Accessibility Template (VPAT)</ExternalLink> is available.
...
We recommend reading <ExternalLink inline={true} href="https://accessibility.huit.harvard.edu/interpret-vpat">How to Interpret a VPAT</ExternalLink> from Harvard University and <ExternalLink inline={true} href="https://www.accessibilityoz.com/2019/09/how-to-read-a-vpat/">How to tell if a VPAT is reasonable in ten minutes or less</ExternalLink> from Accessibility Oz to learn more about VPATs.