...
- If there are only a couple, consider replacing some images with alternatives that include people with disabilities. You can find <ExternalLink inline href="https://www.ta11y.org/learning/topic?key=inclusive_img">sources for images for disability inclusion</ExternalLink> on our tool, <span class="text-brand text-primary fw-bold">t<span class="fw-lighter">a11y</span>.org</span>.
...
And remember to include <ExternalLink inline href="https://www.ta11y.org/learning/topic?key=create_design.write_alt">alternative text</ExternalLink> on your images!