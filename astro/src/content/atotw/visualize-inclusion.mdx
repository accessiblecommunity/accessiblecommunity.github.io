...
- If there are only a couple, consider replacing some images with alternatives that include people with disabilities. You can find [sources for images for disability inclusion](https://www.ta11y.org/learning/topic?key=inclusive_img) on our tool, **ta11y.org**.
