...
GSA provides [sample contract language](https://www.section508.gov/buy/define-accessibility-criteria/) for various situations. You can use this as a starting point and make changes that you need such as replacing “Section 508” with the appropriate standard or or WCAG version. 
