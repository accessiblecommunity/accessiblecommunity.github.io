...
2. Use an accessible color scheme. If you don't know how, give [Color Safe](http://colorsafe.co/) a try.
    - Select a color that you want to use and set the text size. For emails, we recommend using 12- or 14-point font.
...
4. Ask about accommodations on the invitation and let people know how to request them ahead of time. The requested accommodations may include dietary needs, interpreters, accessible locations, large print menus, fragrance-free environments or other needs. It is always better to ask than to assume.
