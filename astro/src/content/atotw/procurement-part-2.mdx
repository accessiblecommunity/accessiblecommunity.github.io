...
2. Be careful if mention overlays. It is generally best to avoid products that use overlays to provide accessibility - they are less likely to be successful and more likely to break.
    - <ExternalLink inline href="https://overlayfactsheet.com/">Learn more about overlays</ExternalLink> at the Overlay Fact Sheet.
3. Expect them to discuss one of more of the following standards:
    - <ExternalLink inline href="https://developer.mozilla.org/en-US/docs/Web/Accessibility/Understanding_WCAG">WCAG</ExternalLink> (ideally 2.2 A & AA),
    - <ExternalLink inline href="https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA">ARIA</ExternalLink>,
    - <ExternalLink inline href="https://en.wikipedia.org/wiki/Section_508_Amendment_to_the_Rehabilitation_Act_of_1973">Section 508</ExternalLink> (in America),
    - <ExternalLink inline href="https://en.wikipedia.org/wiki/EN_301_549">EN 301-549</ExternalLink> (in Europe), 
    - The <ExternalLink inline href="https://www.canada.ca/en/employment-social-development/programs/accessible-canada/act-summary.html">Canadian Accessibility Act</ExternalLink> (in Canada).
