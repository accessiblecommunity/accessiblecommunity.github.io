...
As you pick your colors, keep accessibility in mind. We provide a <ExternalLink inline={true} href="https://www.ta11y.org/learning/topic?key=create_design.h_color_scheme">detailed, step-by-step guide on ta11y</ExternalLink>. If you've never thought about your color scheme holistically, this is a great chance to do so. 
...
If you already have a color scheme for your organization, consider using <ExternalLink inline={true} href="https://contrast-grid.eightshapes.com/">Eight Shapes</ExternalLink> to find out how to use the colors you have in accessible combinations. 
