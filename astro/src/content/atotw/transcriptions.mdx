...
The easiest way to create a visual transcript is to export a caption file and remove the time stamps. Then, add any important visual information. There are [several free ways to create transcripts](/blog/free-transcription/) using common applications and devices.
