...
We have posted the list of 2024 <ExternalLink href="https://www.ta11y.org/learning/topic?key=plan.z_holidays" inline={true}>disabilty-related awareness dates</ExternalLink> on ta11y.org.  Our goal is to provide a list of the calendar dates and links to content you can use to help raise awareness within your organization and community.
