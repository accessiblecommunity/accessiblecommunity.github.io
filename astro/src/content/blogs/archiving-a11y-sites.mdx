...
- If it is not, add the urls to the Internet Archive.
...
3. Enger the URL in the visually labeled "Wayback Machine" search field.
...
3. Enter the URL in the field visually labeled "Save Page Now".
   - Unforutnately, this field does not have a clear label and often reads as "``https://``".